...
##R3D72
Listening to Metallica while practicing splitting arrays into chunks. Chunk is such a funny word,  sounds like a name for some moronic mumble rapper (i.e., Lil Chunkz).  Also, cleaned the client's WordPress site of malware.  😇
...
##R3D79
Practiced  finding vowels algorithm using regular expressions - I  just forgot to tweet about it yesterday!  😳 Also listened to my favorite podcast - @syntaxfm 😍 #podcast #webdev #syntax #syntaxfm #algorithm #coding #nerd #programming #javascript

##R3D80
The matrix spiral algorithm is stuff of nightmares...  I have no idea what's it for or what it does, allz I knwoz is that it's scary! 😱 All those loops make my little brain want to explode! 🧠 🤪 #BrainFart #Algorithms #programming #coding #webdevelopment
...
##R3D88
Finished the linked lists sections of the course and up next is the section on binary trees. 🤓 Alsp, a friend @CodesNine helped me setup (lot of steps to get it running) ESLint and Prettier, so my code is  linted and prettier!
...
##R3D97
Got back to learning React and spent some time setting up  PhpMyAdmin on a Ubuntu 18  in order to migrate a WP site from a crappy slow-ass shared hosting to a real OG VPS server. 😎 #reactjs #Ubuntu #linux #HOSTING #javascript #wordpress #MySQL #SSH #LAMP
